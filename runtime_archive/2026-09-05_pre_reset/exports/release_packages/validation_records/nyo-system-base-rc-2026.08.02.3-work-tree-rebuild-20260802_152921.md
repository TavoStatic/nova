...
- Artifact path: C:\NOVA\runtime\exports\release_packages\nyo-system-base-rc-2026.08.02.3-work-tree-rebuild-20260802_152921.zip
- Artifact version: 2026.08.02.3
- Version source: 
- Release channel: rc
...
- Python source used during install: C:\NOVA\.venv\Scripts\python.exe (3.13.1)
...
- full regression generated_at: 2026-08-01 00:09:41
...
- Result: fail
- Blocking issues: full regression status is stale: age_sec=141677 max_age_sec=21600; nova wiring-check --offline failed; nova test failed; nova webui-start --host 127.0.0.1 --port 8080 failed
