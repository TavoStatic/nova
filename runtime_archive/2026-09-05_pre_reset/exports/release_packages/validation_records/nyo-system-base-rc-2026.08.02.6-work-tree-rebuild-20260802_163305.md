...
- Artifact path: C:\NOVA\runtime\exports\release_packages\nyo-system-base-rc-2026.08.02.6-work-tree-rebuild-20260802_163305.zip
- Artifact version: 2026.08.02.6
- Version source: 
- Release channel: rc
...
- Python source used during install: C:\Python312\python.exe (3.12.6)
...
- Result: fail
- Blocking issues: full regression status is stale: age_sec=156134 max_age_sec=21600; nova wiring-check --offline failed; nova test failed; nova webui-start --host 127.0.0.1 --port 8080 failed
