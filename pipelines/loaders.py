...
def load_pipeline_manifest(pipeline_dir: Path) -> PipelineManifest:
    ...
    return PipelineManifest(
        ...
        population_definitions_path=_resolve_path(pipeline_dir, data.get("population_definitions")),
        vendor_dictionary_path=_resolve_path(pipeline_dir, data.get("vendor_dictionary")),
        predefined_reports_path=_resolve_path(pipeline_dir, data.get("predefined_reports")),
