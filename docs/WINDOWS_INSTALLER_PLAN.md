...
Status note: package zip validation is current through same-machine checks for the ledger-owned release candidate, with no blocking release issues. Independent installer build/validation remains a separate release task.
