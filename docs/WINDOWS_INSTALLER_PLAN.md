...
Status note: package zip validation is current through same-machine checks for `2026.05.18.23`, with no blocking release issues. Independent installer build/validation remains a separate release task.
