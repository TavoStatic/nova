...
def self_identity_web_challenge_reply(*, assistant_name: str) -> str:
    return (
        "You should not need web research for my name. "
        f"I already know my name is {assistant_name}, so that should be answered directly from my verified identity facts."
    )


def assistant_name_reply(text: str, *, assistant_name: str) -> str:
...
def developer_full_name_reply(*, developer_name: str, developer_nickname: str) -> str:
    if developer_nickname and developer_nickname.lower() != developer_name.lower():
