...
def consume_conversation_followup(
    ...
    *,
    ...
    if not isinstance(state, dict):
        ...
        if looks_like_retrieval_followup_fn(text) and any(
            ...
            return (
                True,
                "I need the active retrieval context first. Ask me to search again or tell me which topic or source you want me to inspect.",
                state,
            )
        return False, "", state
