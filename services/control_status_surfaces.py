...
_SIGNAL_INGESTION_DERIVED_KEYS = (
    ...
    "live_closure_inventory_verified_root_count",
    "live_closure_inventory_unverified_root_count",
    "live_closure_depth_counts",
    "wiring_inventory_ok",
    ...
    "observation_spine_ok",
    "observation_spine_status",
    "observation_finding_code",
    "observation_finding_label",
    "observation_effect",
    "observation_effect_label",
    "observation_subject",
    "observation_input_ref",
    "observation_window_count",
    "observation_intervening",
    "observation_self_questions",
    "observation_internal_positions",
    "observation_self_model",
    "observation_cognitive_events",
    "work_tree_truth_status",
    "work_tree_tree_count",
    "work_tree_active_tree_count",
    "work_tree_branch_count",
    "work_tree_open_task_count",
    "work_tree_blocked_branch_count",
    "work_tree_operator_hold_branch_count",
    "work_tree_self_repair_blocked_branch_count",
    "work_tree_self_repair_observing_branch_count",
    "work_tree_pending_branch_count",
    "work_tree_working_branch_count",
    "work_tree_complete_branch_count",
    "work_tree_observing_branch_count",
    "work_tree_blocked_observing_branch_count",
    "work_tree_latent_root_signal_count",
    "work_tree_release_stale_ready_count",
    "temporal_enabled",
    ...
    "last_regression_reason",
    "last_regression_certification",
    "nova_mission_status",
    "nova_mission_action",
    "nova_mission_green_cycle",
    "nova_mission_headline",
    "nova_mission_truth_ready",
    "nova_mission_truth_blockers",
    "nova_mission_owner_blockers",
    "nova_mission_green_blockers",
    "nova_mission_blocking_owner_count",
    "nova_mission_core_gate_source",
    "nova_mission_sustained_watch",
    "nova_mission_watch_streak",
    "core_thinning_sync_status",
    "core_thinning_sync_at",
    "core_thinning_order_count",
    "core_thinning_added_count",
    "core_thinning_resolved_count",
    "core_thinning_tree_id",
    "release_runtime_truth",
    "http_model_runtime_probe",
    "http_model_runtime_probe_ok",
    "http_model_runtime_missing_keys",
