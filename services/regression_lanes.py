...
SOURCE_PROFILE_LANES: dict[str, list[str]] = {
    **COMPACT_REGRESSION_LANES,
    ...
    "source_memory_identity": [
        ...
        "tests.test_nova_identity_answers",
        "tests.test_nova_identity_preferences",
    ...
    "source_patch_pipeline": [
        "tests.test_nova_followup_dispatch",
    ...
    "source_reply_quality_contracts": [
        ...
        "tests.test_nova_reply_contracts",
        "tests.test_nova_reply_contracts_service",
        "tests.test_nova_reply_deterministic",
        "tests.test_nova_truth_hierarchy",
    ],
    "source_runtime_core": [
    ...
    "source_test_ecosystem": [
        ...
        "tests.test_nova_command_handlers",
        "tests.test_nova_conversation_followups_service",
        "tests.test_nova_correction_parsing",
        "tests.test_nova_developer_profile",
        ...
        "tests.test_nova_retrieval_followups_service",
        "tests.test_nova_routing_helpers",
        "tests.test_nova_routing_support",
        "tests.test_nova_session_followups_service",
        "tests.test_nova_session_state_service",
        "tests.test_nova_supervisor_flow",
        "tests.test_nova_supervisor_flow_cli",
        "tests.test_nova_turn_helpers",
        "tests.test_nova_turn_heuristics",
