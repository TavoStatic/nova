...
COMPACT_REGRESSION_LANES: dict[str, list[str]] = {
    "unit": [
        ...
        "tests.test_nova_live_closure_service",
        ...
        "tests.test_nova_mission_service",
        ...
        "tests.test_nova_setup_wizard",
        "tests.test_nova_shell_admin",
        "tests.test_nova_shell_auth",
        "tests.test_nova_shell_http_trust",
        "tests.test_nova_shell_roles",
        "tests.test_nova_shell_store",
        "tests.test_work_tree_pressure_snapshot_service",
        "tests.test_work_tree_task_progress",
        "tests.test_solution_trail",
...
SOURCE_PROFILE_LANES: dict[str, list[str]] = {
    **COMPACT_REGRESSION_LANES,
    ...
    "source_http_api_control": [
        "tests.test_control_status_surfaces_service",
        "tests.test_frontdoor_cli_parity_service",
        "tests.test_leah_fast_chat",
        "tests.test_leah_frontdoor",
        "tests.test_nova_turn_contract",
