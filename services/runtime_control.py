        ...
        *,
        ...
        return {
            ...
            "last_autonomy_orchestrator": {
                ...
                "decision_type": str(last_autonomy_orchestrator.get("decision_type") or ""),
                "decision": str(last_autonomy_orchestrator.get("decision") or ""),
                "recommended_action": dict(last_autonomy_orchestrator.get("recommended_action") or {}) if isinstance(last_autonomy_orchestrator.get("recommended_action"), dict) else {},
                "confidence": float(last_autonomy_orchestrator.get("confidence", 0.0) or 0.0),
                ...
                "explain_text": str(last_autonomy_orchestrator.get("explain_text") or ""),
