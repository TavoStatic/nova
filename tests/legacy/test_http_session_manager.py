...
class TestHttpSessionManager(unittest.TestCase):
    ...
    def test_control_html_smoke_keeps_core_endpoints_and_tabs(self):
        ...
        self.assertIn('id="btnWorkTreeRefresh"', html)
        self.assertIn('id="workTreeSvg"', html)
        self.assertIn('id="workTreeBranchInfoBody"', html)
        self.assertNotIn('data-inspector-tab="scheduled-tree"', html)
        self.assertIn('/api/control/work-trees', script)
        self.assertIn('function fetchWorkTrees()', script)
        self.assertIn('function visibleViewName(name)', script)
        self.assertIn('function syncScheduledTreeView(activeView)', script)
        self.assertIn('sessionModeMeta', script)
