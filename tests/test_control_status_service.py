...
class TestControlStatusService(unittest.TestCase):
    ...
    def test_runtime_status_payload_collects_supplier_outputs(self):
        ...
        self.assertIn("observation_spine", payload)
        self.assertIn("observation_finding_code", payload)
        ...
        self.assertTrue(payload.get("source_wiring_probe_ok"))
        self.assertEqual(payload.get("source_wiring_probe_gap_count"), 0)
        self.assertEqual(payload.get("source_wiring_probe_advisory_actions_without_execution"), [])
