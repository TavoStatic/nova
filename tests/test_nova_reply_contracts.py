...
class TestNovaReplyContracts(unittest.TestCase):
    def test_truthful_limit_reply_clarifies_mixed_request(self):
        ...
        self.assertIn("split the request", reply.lower())
    ...
    def test_truthful_limit_reply_uses_grounded_source_guidance_for_request(self):
        ...
        self.assertIn("grounded source or tool", reply.lower())
        self.assertIn("do better next time", reply.lower())
